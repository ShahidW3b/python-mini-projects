...
A collection of Python command-line applications developed while learning Python, data structures, object-oriented programming, and software design.
...
Python-CLI-Projects/
│
├── Personal-Academic-Progress-Manager/
├── Personal-Book-Collection-Manager/
├── Personal-Study-Performance-Tracker/
...
Each project contains a `screenshots/` folder showing the application's interface and features.

---

## 🎯 Goal

This repository documents my journey from beginner Python programs to more advanced projects involving object-oriented programming, file handling, and software design.
